 ...
 */
@Stateless
@Local(UserApplicationServiceLocal.class)
@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
public class UserApplicationServiceBean extends AbstractEntityServiceBean<UserApplication> implements UserApplicationServiceLocal {
