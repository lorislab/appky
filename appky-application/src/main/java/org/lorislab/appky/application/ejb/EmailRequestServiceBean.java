 ...
 */
@Stateless
@Local(EmailRequestServiceLocal.class)
@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
public class EmailRequestServiceBean extends AbstractEntityServiceBean<EmailRequest> implements EmailRequestServiceLocal {
