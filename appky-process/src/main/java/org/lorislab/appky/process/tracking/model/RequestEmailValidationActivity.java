...
/**
 * The request email validation activity.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class RequestEmailValidationActivity extends AbstractStoreTrackingData {
     ...
     */
    public RequestEmailValidationActivity(String requestGuid) {
        super(UserActivity.REQUEST_EMAIL_VALIDATION);
