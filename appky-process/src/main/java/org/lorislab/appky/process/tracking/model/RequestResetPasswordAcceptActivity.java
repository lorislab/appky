...
/**
 * The accept request reset password activity.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class RequestResetPasswordAcceptActivity extends AbstractStoreTrackingData {
     ...
     */
    public RequestResetPasswordAcceptActivity(String requestGuid) {
        super(UserActivity.REQUEST_RESET_PASSWORD_ACCEPT);
