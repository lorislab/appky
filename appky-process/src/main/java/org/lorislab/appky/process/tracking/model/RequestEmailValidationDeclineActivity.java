...
/**
 * The decline request email validation activity.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class RequestEmailValidationDeclineActivity extends AbstractStoreTrackingData {
     ...
     */
    public RequestEmailValidationDeclineActivity(String requestGuid) {
        super(UserActivity.REQUEST_EMAIL_VALIDATION_DECLINE);
