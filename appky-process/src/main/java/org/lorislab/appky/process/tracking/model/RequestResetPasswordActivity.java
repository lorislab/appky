...
/**
 * The request forgot password activity.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class RequestResetPasswordActivity extends AbstractStoreTrackingData {
     ...
     */
    public RequestResetPasswordActivity(String requestGuid) {
        super(UserActivity.REQUEST_RESET_PASSWORD);
