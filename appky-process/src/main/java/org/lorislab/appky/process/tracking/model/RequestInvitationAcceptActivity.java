...
/**
 * The accept request invitation activity.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class RequestInvitationAcceptActivity extends AbstractStoreTrackingData {
     ...
     */
    public RequestInvitationAcceptActivity(String requestGuid) {
        super(UserActivity.REQUEST_INVITATION_ACCEPT);
