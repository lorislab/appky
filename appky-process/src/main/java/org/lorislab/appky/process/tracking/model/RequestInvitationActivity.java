...
/**
 * The request invitation activity.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class RequestInvitationActivity extends AbstractStoreTrackingData {
     ...
     */
    public RequestInvitationActivity(String requestGuid, String email) {
        super(UserActivity.REQUEST_INVITATION);
