...
/**
 * The configuration save action.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class ConfigSaveAction extends AbstractViewControllerAction<ConfigViewController> {

    /**
     * The UID for this class.
     */
    private static final long serialVersionUID = -7689831147786816183L;
     ...
     */
    public ConfigSaveAction(ConfigViewController parent) {
        super(parent);
    }
