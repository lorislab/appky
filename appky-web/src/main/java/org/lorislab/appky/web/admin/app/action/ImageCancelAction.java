...
/**
 * The image cancel action.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class ImageCancelAction extends AbstractViewControllerAction<ImageViewController> {
     ...
     */
    public ImageCancelAction(ImageViewController parent) {
        super(parent);
    }
}
