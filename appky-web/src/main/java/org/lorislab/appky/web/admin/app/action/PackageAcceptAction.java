...
/**
 * The package accept action.
 *
 * @author Andrej Petras <andrej@ajka-andrej.com>
 */
public class PackageAcceptAction extends AbstractViewControllerAction<PackageViewController> {

    /**
     * The UID for this class.
     */
    private static final long serialVersionUID = 3421557841025687390L;
     ...
     */
    public PackageAcceptAction(PackageViewController parent) {
        super(parent);
    }
