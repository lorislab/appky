 ...
 */
public class UsersMenuAction extends AbstractViewControllerAction<MenuViewController> {
     ...
     */
    public UsersMenuAction(MenuViewController parent) {
        super(parent);
    }
    ...
    public boolean isAvailable() {
        return FacesUtil.isUserInRole(ApplicationRoles.MENU_USERS_ROLE);
    }
    ...
    public Object execute() throws Exception {
        return getParent().menuUsersAction();
    }
}
