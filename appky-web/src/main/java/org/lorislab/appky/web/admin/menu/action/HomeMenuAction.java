 ...
 */
public class HomeMenuAction extends AbstractViewControllerAction<MenuViewController> {
     ...
     */
    public HomeMenuAction(MenuViewController parent) {
        super(parent);
    }
    ...
    public Object execute() throws Exception {
        return getParent().menuHomeAction();
    }
}
