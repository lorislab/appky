 ...
 */
public class ApplicationMenuAction extends AbstractViewControllerAction<MenuViewController> {
    ...
    public boolean isAvailable() {
        return FacesUtil.isUserInRole(ApplicationRoles.MENU_APPLICATION_ROLE);
    }
    ...
    public Object execute() throws Exception {
        return getParent().menuApplicationAction();        
    }
}
