 ...
 */
public class RoleSaveAction extends AbstractViewControllerAction<RoleViewController> {
     ...
     */
    public RoleSaveAction(RoleViewController parent) {
        super(parent);
    }
    ...
    public boolean isEnabled() {
        ...
        if (result) {
            result = getParent().getModel().isEditable();
        }
        return result;
    }
