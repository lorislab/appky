 ...
 */
public class RolesMenuAction extends AbstractViewControllerAction<MenuViewController> {
     ...
     */
    public RolesMenuAction(MenuViewController parent) {
        super(parent);
    }
    ...
    public Object execute() throws Exception {
        return getParent().menuRolesAction();
    }
}
