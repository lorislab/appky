 ...
 */
public class StatisticsMenuAction extends AbstractViewControllerAction<MenuViewController> {
     ...
     */
    public StatisticsMenuAction(MenuViewController parent) {
        super(parent);
    }
    ...
    public boolean isAvailable() {
        return FacesUtil.isUserInRole(ApplicationRoles.MENU_STATISTICS_ROLE);
    }
    ...
    public Object execute() throws Exception {
        return Navigation.NAV_MENU_TO_STATISTICS;
    }
}
