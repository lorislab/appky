 ...
 */
public class PreferencesMenuAction extends AbstractViewControllerAction<MenuViewController> {
     ...
     */
    public PreferencesMenuAction(MenuViewController parent) {
        super(parent);
    }
    ...
    public boolean isAvailable() {
        return FacesUtil.isUserInRole(ApplicationRoles.MENU_PREFERENCES_ROLE);
    }
    ...
    public Object execute() throws Exception {
        return getParent().menuPreferencesAction();
    }
}
