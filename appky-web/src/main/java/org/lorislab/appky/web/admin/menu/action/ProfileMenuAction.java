 ...
 */
public class ProfileMenuAction extends AbstractViewControllerAction<MenuViewController> {
    ...
    public boolean isAvailable() {
        return FacesUtil.isUserInRole(ApplicationRoles.MENU_PROFILE_ROLE);
    }
    ...
    public Object execute() throws Exception {
        return Navigation.NAV_MENU_TO_PROFILE;
    }
}
